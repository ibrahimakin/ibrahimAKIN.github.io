class SocialIcons extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = `
            <ul class="soc">
                <li>
                    <a class="icon-13" href="https://github.com/ibrahimakin" target="_blank" title="GitHub">
                ...
                <li>
                    <a class="icon-7" href="https://gitlab.com/ibrahimAKIN" target="_blank" title="GitLab">
                        <svg viewbox="-1 -3 32 32">
                ...
                <li>
                    <a class="icon-23" href="https://stackoverflow.com/users/9259201/ibrahimAKIN" target="_blank" title="StackOverflow">
                        <svg viewbox="0 0 512 512">
                ...
                <li>
                    <a class="icon-26" href="https://x.com/iibrahimAKIN" target="_blank" title="X">
                ...
                <li>
                    <a class="icon-10" href="https://facebook.com/iibrahimAKIN" target="_blank" title="Facebook">
                        <svg viewbox="0 0 512 512">
                ...
                <li>
                    <a class="icon-15" href="https://instagram.com/iibrahimAKIN" target="_blank" title="Instagram">
                        <svg viewbox="0 0 512 512">
                ...
                <li>
                    <a class="icon-31" href="http://ibrahim-akin.blogspot.com" target="_blank" title="Blogger">
                        <svg viewbox="0 0 512 512">
                ...
                <li>
                    <a class="icon-17" href="https://www.linkedin.com/in/ibrahim-AKIN" target="_blank" title="LinkedIn">
                        <svg viewbox="0 0 512 512">
