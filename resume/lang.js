const lang_obj = {
    tr: {
        ...
        projects: 'Projeler',
        r_projects: 'PROJELER',
        search: 'Search YouTube, kullanıcıların YouTube ana sayfasını atlayarak aramalarını daha hızlı bulmalarına yardımcı olan bir tarayıcı eklentisidir. Kullanıcılar, YouTube\'da hızlı bir şekilde arama yapmak için metni seçip sağ tıklayabilir veya eklenti penceresini açabilirler. Ayrıca, kullanıcılar YouTube Shorts\'u normal video olarak açabilir veya ileri ve geri sarma kısayollarıyla oynatmayı kolayca kontrol edebilirler.',
    ...
    en: {
        ...
        projects: 'Projects',
        r_projects: 'PROJECTS',
        search: 'Search YouTube is a browser extension that helps users find their searches faster by bypassing the YouTube home page. Users can select text and right-click, or open the extension pop-up to search on YouTube quickly. Additionally, users can open YouTube Shorts as regular videos or control playback easily with forward and rewind shortcuts.',
