...
var ASM_CONSTS = {
 ...
 362060: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 362143: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 362212: () => { return window.innerWidth; },  
 362242: () => { return window.innerHeight; }
};
