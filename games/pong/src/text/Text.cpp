...
bool Text::s_ttfInitialized = false;

// Constructor
// example: "./assets/fonts/8bitOperatorPlus8-Regular.ttf"
Text::Text(std::string fontfilepath, size_t fontSize)
{
...
void Text::DrawText(SDL_Renderer *renderer, std::string text, int x, int y, int w, int h)
{
